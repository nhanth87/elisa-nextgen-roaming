...
/** HMAC-signed admin session cookie (adapted from gmlc-microjainslee). */
public final class SignedSessionCookie {
    public static final String COOKIE_NAME = "stp_admin_session";
    public static final String CSRF_COOKIE_NAME = "stp_admin_csrf";
    public static final String CSRF_HEADER = "X-STP-CSRF";
    ...
    public static String issue(String hmacSecret, String username, String role, String tenantId,
        ...
        if (hmacSecret == null || hmacSecret.isBlank()) {
            throw new IllegalStateException("stp.admin.session-hmac-secret required");
        }
    ...
    public static String clearCsrfCookieHeader(boolean secure) {
        return CSRF_COOKIE_NAME + "=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0"
                + (secure ? "; Secure" : "");
    }
